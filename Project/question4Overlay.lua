...
function scene:create(event)
	...
	local helpInfo = display.newText( [[Any one of these reasons may cause 
	someone to hack your computer.
	
	It is always recommended that you 
	follow proper security practises. 
	Such as, a strong password, and 
	other things that will mitigate these 
	issues.]], 0, 0, "Helvetica", 18 )
