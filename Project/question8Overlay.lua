...
function scene:create(event)
	...
	local helpInfo = display.newText( [[In computing, a firewall is a network 
	security system that monitors and 
	controls incoming and outgoing 
	network traffic based on 
	predetermined security rules.
	
	All legitemate installations of 
	Windows and other Operating 
	Systemsshould come with the 
	firewallpre-configured. So as 
	to ensure your safety.]], 0, 0, "Helvetica", 18 )
