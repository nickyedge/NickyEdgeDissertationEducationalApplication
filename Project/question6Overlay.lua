...
function scene:create(event)
	...
	local helpInfo = display.newText( [[Always scan attachments and 
	files with antivirus before 
	installing them on your computer. 
	
	Don't open anything that you aren't 
	expecting or doesn't come from a 
	trusted source.]], 0, 0, "Helvetica", 18 )
