...
function scene:create(event)
	...
	local helpInfo = display.newText( [[Deleteing the message is an option, 
	but reporting the message as phishing 
	makes your email provider alert to 
	the scams that are prevalent and 
	take action to block them. Never 
	respond to a request for personal 
	information.]], 0, 0, "Helvetica", 18 )
