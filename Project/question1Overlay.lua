...
function scene:create(event)
	...
	local helpInfo = display.newText( [[In the case of computers, a 
	worm is a piece of code that 
	usually invades your computer 
	through upatched software and 
	replicates itself until it reaches 
	the internet and spreads there 
	as well.
	
	Always pay attention to what you 
	download, and ensure you have 
	measures such as anti-virus
	in place.]], 0, 0, "Helvetica", 18 )
