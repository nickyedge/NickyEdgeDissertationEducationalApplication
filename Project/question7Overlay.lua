...
function scene:create(event)
	...
	local helpInfo = display.newText( [[Even if you shut down the computer, 
	someone could restart it and 
	have access to your personal 
	information unless you 
	passowrd protect the computer.
	
	Please be sure to have a strong
	password in place. A password
	such as, 'password' can easily
	be guessed.]], 0, 0, "Helvetica", 18 )
