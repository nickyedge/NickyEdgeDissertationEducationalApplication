...
function scene:create(event)
	...
	local helpInfo = display.newText( [[You should make sure that any 
	antivirus and other programs are 
	up to date before browing the internet, 
	and certainly before entering any 
	type of personal information.
	
	If something seems suspicious or
	you aren't confident, then ask for
	help or stay away from these things.]], 0, 0, "Helvetica", 18 )
